...
if (isset($_GET['edit'])) {
	$id = $_GET['edit'];
    $edit_state = true;
	$rec = $pdo->query("SELECT * FROM moto WHERE id=$id");
    $record = $rec->fetch();
...
<center> <strong><h1> Liste des motos </h1></srong> </center>
...
<table>
	...
	<td>
	    <a class="edit_btn" href="moto1.php?edit=<?php echo $row['id']; ?>">Modifier</a>
	</td>
	<td>
	<a class="del_btn" href="server3.php?del=<?php echo $row['id']; ?>">Supprimer</a>
	</td>
	</tr>
<?php } ?>
